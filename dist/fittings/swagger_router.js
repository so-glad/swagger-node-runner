...
module.exports = function create(fittingDef, bagpipes) {
  ...
  assert(~allowedCtrlInterfaces.indexOf(fittingDef.controllersInterface), 'value in swagger_router config.controllersInterface - can be one of ' + allowedCtrlInterfaces + ' but got: ' + fittingDef.controllersInterface);
  ...
  swaggerNodeRunner.api.getOperations().forEach(function (operation) {
    ...
    assert(~allowedCtrlInterfaces.indexOf(interfaceType), 'whenever provided, value of ' + CONTROLLER_INTERFACE_TYPE + ' directive in openapi doc must be one of ' + allowedCtrlInterfaces + ' but got: ' + interfaceType);
  });
